    ...
    <div className="space-y-8 fade-in">
      ...
      <div className="glass rounded-2xl p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <button className="btn bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl p-4 text-center hover:shadow-lg transition-all duration-300 hover:scale-105">
            <svg className="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          ...
          <button className="btn bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl p-4 text-center hover:shadow-lg transition-all duration-300 hover:scale-105">
            <svg className="w-6 h-6 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
